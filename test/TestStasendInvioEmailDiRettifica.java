...
public class TestStasendInvioEmailDiRettifica extends TestCase {
	...
	private void readFile() throws Exception {
		File file = new File("/opt/java/csi/mmd/workspace/stacore_stasend/test/java/test/stasend/data/data.txt");
		
		BufferedReader br = new BufferedReader(new FileReader("/opt/java/csi/mmd/workspace/stacore_stasend/test/java/test/stasend/data/data.txt"));
	...
	public void testOperationInvioDiRettifica() {
		...
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader("/opt/java/csi/mdd/workspace/stacore_stasend/test/java/test/stasend/data/data.txt"));
			String line;
			boolean first = true;
